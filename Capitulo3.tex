...
\begin{figure}[H]
	...
	\caption[Estación de trabajo para procesamiento y entrenamiento.]{Estación de trabajo utilizada para el procesamiento de datos y entrenamiento de la red neuronal.
...
\begin{figure}[htbp]
	...
	\caption[Pipeline de procesamiento de imagen con YOLOv8 y CLAHE.]{Pipeline de procesamiento de imagen implementado. La secuencia muestra: (Arriba) Mejora de la imagen mediante escala de grises y realce de contraste CLAHE.
...
\begin{figure}[H]
	...
	\caption[Correspondencia entre imagen infrarroja y modelo 3D ocular.]{Correspondencia entre la señal visual capturada y su representación 
		...
		transformación constituye el núcleo del pipeline de estimación oculomotora 
		propuesto.}
...
Se ha descrito el diseño experimental controlado con 14 participantes, la configuración del hardware de captura de alta velocidad (120 FPS) y el pipeline de procesamiento que transforma imágenes crudas en descriptores biométricos complejos como el Jerk y la Dimensión Fractal.
