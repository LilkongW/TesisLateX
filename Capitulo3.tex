...
\begin{figure}[htbp]
	...
	\caption[Muestra representativa de ojos capturados ($N=14$).]{Muestra representativa de los ojos capturados durante la sesión 
		experimental. Cada imagen corresponde a un participante distinto del estudio 
		($N=14$), evidenciando la variabilidad morfológica inter-sujeto en 
