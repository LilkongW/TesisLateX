...
La presente investigación se fundamenta en la convergencia de la física aplicada y el análisis computacional para abordar desafíos críticos en la interacción humano-máquina y la asistencia médica. Como señala Arias \cite{arias2010}, la justificación de un proyecto debe exponer las razones de su ejecución y sus aportes desde una perspectiva teórica o práctica. En este contexto, el estudio se sustenta en la premisa de que el ojo humano no es solo un órgano sensorial, sino una fuente de información biométrica y dinámica de alto valor. Desde la óptica física y el procesamiento de señales, el movimiento ocular contiene patrones subyacentes que, tras ser extraídos y analizados, permiten inferir intenciones y estados fisiológicos del usuario.

Como investigadores en el área de la física, el interés principal radica en la capacidad de decodificar esta información mediante herramientas de análisis de imágenes y modelos matemáticos. El ojo emite señales que a menudo son imperceptibles en una observación convencional; por tanto, el desarrollo de algoritmos que permitan una extracción precisa de estos datos representa un avance significativo en la física aplicada. Este enfoque permite transformar señales ópticas crudas en conclusiones científicas robustas, estableciendo un puente entre la fenomenología del movimiento ocular y su aplicación en sistemas de control.

Finalmente, este esfuerzo técnico encuentra su propósito más trascendente en el impacto social, al ofrecer soluciones a individuos con discapacidades motoras severas —como parálisis cerebral o accidentes cerebrovasculares—. Al convertir el análisis de la información ocular en un canal de comunicación funcional (\textit{eye-tracking}), la física trasciende el laboratorio para convertirse en una herramienta asistiva que garantiza autonomía. Así, la investigación se justifica por su dualidad: el rigor del análisis de datos físicos y la urgencia de desarrollar tecnología inclusiva que mejore significativamente la calidad de vida de los usuarios.
